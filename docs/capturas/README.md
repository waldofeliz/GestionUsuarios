...
Los PNG de este directorio los genera `@senior-fullstack-developer-agent` (no se inventan assets). El README de la raíz ya apunta a estos **nombres fijos**:
...
Los cuatro PNG ya están versionados junto al README.

Receta de producto y tamaño: handoff **PM-DEV-20260920-1**.
